...
export function ChatHeader({
  ...
  return (
    <div className="flex w-full justify-between items-center py-4 px-4 bg-[#212121]">
      ...
      <button className="flex items-center gap-1 rounded-full py-2 ps-2.5 pe-3 text-sm font-medium text-white hover:bg-[#E4E4F6] dark:bg-[#373669] dark:text-[#DCDBF6] dark:hover:bg-[#414071] bg-[#373768]">
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
